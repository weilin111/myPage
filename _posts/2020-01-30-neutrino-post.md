...
$${v = \frac{2E}{m} = \left( 2.4 \times 10^{15} \right)^{2}
}{= 0.16\ c\text{\ \ }}$$
...
$$相位差 = i\ \frac{1}{2}\frac{m_{i}c^{4}}{E\hslash}t$$
...
探测方法：Each cell is filled with a mineral oil based liquid
