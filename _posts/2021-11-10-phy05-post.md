...
它相当于将质量均匀铺在以Einstein半径的圆上时的密度。那么对于偏转角，

<img src="style/image/ALL_MD_PIC/1643419753948.png" alt="1643419753948" style="zoom:80%;" />

由上式和上面的几何图像可以推理，当面密度等于$\Sigma_{crit}$,视角跟偏转角大小相等。临界面密度只是一种标度，便于衡量偏转的程度。当面质量密度$\Sigma<\Sigma_{crit}$则，是有利于多重像的产生的。
...
### quasar微引力透镜
星星们因引力而汇聚成为星系，一颗星系含有数量巨大的星星，我们的就大约有银河系$10^{11}$颗恒星,即使如此星系是仍然空旷的，绝大部分地方都是真空。考虑一束光穿过一个星系，显然作为引力透镜的星体应当是数不胜数，每颗星星都能产生微小的贡献，因此光线可能一分再分，最后成像变得更为复杂，称这样的透镜现象为`微引力透镜`。
...
物理图像：源、透镜、观测者的望远镜三者共线。作为点光源，呈球面发散的光到达透镜星体时，被引力吸引而汇聚形成平行的光束，之后再射向观测者的望远镜。
