...
function add_game_canvas_to_container(container_id) {
    ...
    class Game {
        ...
        constructor(ctx, canvas) {
            ...
            this.simulator = new dynamicSystemLab(this)
    ...
    class dynamicSystemLab {
        ...
        constructor(game) {
            ...
            this.graph_list.push(new iterationPointSet())
    ...
    class iterationPointSet{
        ...
        xyz_list=[
            // {   x:  this.xy_range.x_min+Math.random() * (this.xy_range.x_max-this.xy_range.x_min),
            //     y:  this.xy_range.y_min+Math.random() * (this.xy_range.y_max-this.xy_range.y_min),
            {   x:  this.xy_range.x_max,
                y:  this.xy_range.y_max,
                z:  0}
        ]
        ...
        randomParameter={
            p1:1.215+0.1* 2*(Math.random()-0.5),
            p2:5.237+0.0* 2*(Math.random()-0.5),
        }
        ...
        step_function(xyz){
            ...
            let {x,y,z}=xyz
            let frac=1
            let p1=this.randomParameter.p1 
            let p2=this.randomParameter.p2 
            let x1=Math.sin(x*x-y*y+p1)*frac + (1-frac)*x
            let y1=Math.cos(2*x*y+p2)*frac + (1-frac)*y
            let z1=0
        ...
        constructor(draw_info){
            ...
            for (let i = 0; i < n_row; i++) {
                ...
                for (let j = 0; j < n_col; j++) {
                    ...
                    let temp_grid=new iterationPointSet(draw_info)
