...
function add_game_canvas_to_container(container_id) {
    ...
    class Game {
        ...
        constructor(ctx, canvas) {
            ...
            this.simulator = new phy14Lab(this)
    ...
    class phy14Lab {
        ...
        constructor(game) {
            ...
            this.graph_list.push(new waveLab())
    ...
    class waveLab{
        ...
        constructor(draw_info){
            ...
            for (let i = 0; i < n; i++) {
                ...
                this.source_list.push(new waveSource(this.draw_info)  )
            }
    ...
    class waveSource{
        ...
        constructor(draw_info){
            ...
            this.source_info={
                x:  this.draw_info.x+ Math.random()*this.draw_info.width,
                y:  this.draw_info.y+ Math.random()*this.draw_info.height,
                v_r: Math.random()*this.draw_info.width*0.1,
                timer:0,
                max_timer:getRandomInt(1,50),
                wave_linewidth:getRandomInt(3,10)
        ...
        update(){
            ...
            this.source_info.timer+=1
            this.source_info.timer%=this.source_info.max_timer
            if (this.source_info.timer == 0){
                let wave_element={
                    x:this.source_info.x,
                    y:this.source_info.y,
                    r:0,
                    v_r:this.source_info.v_r,
                }
                this.waveElement_list.push(wave_element)
            }

            this.waveElement_list.forEach(wave => {
        ...
        draw(){
            ...
            ctx.strokeStyle=this.color
            ctx.lineWidth=this.source_info.wave_linewidth
            this.waveElement_list.forEach(circle => {
